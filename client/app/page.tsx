  ...
  return (
    <div className="relative z-10 min-h-screen text-slate-100 font-sans selection:bg-indigo-500 selection:text-white">
          ...
          {user ? (
            <div className="flex items-center gap-3">
              <span className="text-xs font-semibold text-slate-300 hidden sm:inline">
                Welcome back, <strong className="text-white">{displayName}</strong> 👋
              </span>
              <Link href="/dashboard">
                <Button className="bg-indigo-600 hover:bg-indigo-500 text-white font-semibold text-xs px-4 py-2 border-0 shadow-md gap-1.5">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-8 py-10 sm:py-16 space-y-16">
        ...
        {/* ─── SECTIONS 8, 9, 10 VISUALIZATION & DIFFERENTIATION & CTA ─── */}
